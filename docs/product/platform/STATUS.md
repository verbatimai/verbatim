...
| **P3** | Wake-word activation source (openWakeWord, on-device, opt-in) | `p3-plan.md` v2 | ✅ (`p3-review.md`, APPROVE-W-CHANGES) | ✅ full pipeline (`p3-progress.md`) | wiring/config: **compiles ✓** · settings UI ✅ ("Hey Jarvis") · ONNX+cpal core: **authored, `cargo build`-pending** |
